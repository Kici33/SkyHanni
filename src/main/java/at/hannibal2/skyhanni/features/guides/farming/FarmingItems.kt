...
enum class FarmingItems(
    ...
    HELMET(ItemCategory.HELMET, FarmingFortuneData::getArmorFFData),
    CHESTPLATE(ItemCategory.CHESTPLATE, FarmingFortuneData::getArmorFFData),
    LEGGINGS(ItemCategory.LEGGINGS, FarmingFortuneData::getArmorFFData),
    BOOTS(ItemCategory.BOOTS, FarmingFortuneData::getArmorFFData),
    NECKLACE(ItemCategory.NECKLACE, FarmingFortuneData::getEquipmentFFData),
    CLOAK(ItemCategory.CLOAK, FarmingFortuneData::getEquipmentFFData),
    BELT(ItemCategory.BELT, FarmingFortuneData::getEquipmentFFData),
    BRACELET(ItemCategory.BRACELET, FarmingFortuneData::getEquipmentFFData),
    ELEPHANT(ItemCategory.PET, FarmingFortuneData::getPetFFData),
    MOOSHROOM_COW(ItemCategory.PET, FarmingFortuneData::getPetFFData),
    RABBIT(ItemCategory.PET, FarmingFortuneData::getPetFFData),
    BEE(ItemCategory.PET, FarmingFortuneData::getPetFFData),
    SLUG(ItemCategory.PET, FarmingFortuneData::getPetFFData),
    ;
